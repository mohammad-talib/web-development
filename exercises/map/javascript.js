...
function stringItUp(arr){
  ...
  var array = arr.map(x => x.toString());
  return array;
}
console.log(stringItUp([2, 5, 100]));
...
function capitalizeNames(arr){
  ...
  var array = arr.map(x => x.toLowerCase());
  return array;
}
console.log(capitalizeNames(["john", "JACOB", "jinGleHeimer", "schmidt"])); 
/*
...
console.table(readyToPutInTheDOM([
    {
        name: "Angelina Jolie",
        age: 80
    },
...
function doubleValues(arr){
  ...
  * Write a function called extractKey which accepts
    an array of objects and some key and returns a new array with the value
 ...
 function extractFullName(arr){
    var array = arr.map(x => x.first+" "+ x.last);
    return array;
 }
